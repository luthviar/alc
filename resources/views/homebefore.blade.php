...
<body>
	...
	<div id="wrapper">
		<div class="wrapper-holder">
			<header id="header">
				<span class ="Logo"><a href="homeNotLogin"><img src="Elegantic/images/ALS.jpg" width="170px" height="100" > Aerofood Learning Center</a></span>
				<hr class = "style14">
				...
				<a class="menu_trigger" href="#">menu</a>
					<nav id="nav">
						<ul>
							...
							<li><a href="products.html">About ALC</a></li>
